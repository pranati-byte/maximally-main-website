    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        {[...Array(12)].map((_, i) => (
          <div 
            key={i}
            className="fixed w-4 h-4 bg-white pixel-border animate-float opacity-20"
            style={{
              top: `${Math.random() * 100}%`,
        ...
        <div className="relative z-10">
          ...
          <section className="min-h-screen flex flex-col items-center justify-center relative px-4">
            ...
            <div className="mb-12 pixel-float">
              <div className="relative">
                ...
                {/* Mast */}
                <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 w-2 h-16 bg-white minecraft-block"></div>
                {/* Sail with AI circuits */}
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 translate-x-4 w-16 h-12 bg-white minecraft-block flex items-center justify-center">
            ...
            <div className="text-center space-y-8 max-w-4xl relative">
              ...
              <div className="space-y-6">
                <div className="relative inline-block">
                  <div className="minecraft-block bg-white p-4 md:p-6 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
              ...
              {/* Event Details */}
              <div className="minecraft-block bg-white max-w-md mx-auto p-4 md:p-6">
              ...
              <div className="relative my-12">
                <div className="minecraft-block bg-maximally-black p-6 max-w-2xl mx-auto hover:scale-105 transition-transform duration-300">
                  <div className="text-base md:text-xl font-press-start mb-4 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  ...
                  className="pixel-button bg-white text-black font-press-start py-4 px-8 text-lg hover:scale-105 transition-all duration-300 border-2 border-white"
                >
                  REGISTER NOW
                </Button>
                <Button 
          ...
          <section className="py-20 px-4 bg-gray-900">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-press-start text-white mb-6">
                  THE MISSION
                </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="minecraft-block bg-white hover:scale-105 transition-all duration-300">
          ...
          <section className="py-20 px-4 bg-gray-900">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-press-start text-white text-center mb-16">
                CHOOSE YOUR TRACK
              </h2>
            ...
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  const isEven = i % 2 === 0;
                  return (
                    <div key={i} className={`minecraft-block ${isEven ? 'bg-white' : 'bg-maximally-red'} p-4 md:p-6 hover:scale-105 transition-all duration-300`}>
          ...
          <section className="py-20 px-4 bg-gray-900">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="minecraft-block bg-maximally-black p-6 md:p-8">
                ...
                <div className="space-y-6 text-white font-jetbrains text-base md:text-lg">
                  <div className="flex items-start gap-4">
                    <span className="text-2xl md:text-3xl">🎬</span>
                    <div>
                      <div className="font-press-start text-lg md:text-xl text-maximally-red">Demo Video</div>
                      <div className="text-white text-sm md:text-base">Max 2 mins - screen record or natural</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="text-2xl md:text-3xl">📝</span>
                    <div>
                      ...
                      <div className="text-white text-sm md:text-base">What you built, why AI, how it works</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="text-2xl md:text-3xl">🔗</span>
                    <div>
                      ...
                      <div className="text-white text-sm md:text-base">Working link or GitHub repo</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="py-20 px-4 bg-black">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8">
                <div className="minecraft-block bg-white px-4 md:px-6 py-3 inline-block">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {prizes.map((prize, i) => {
                  const colors = ["bg-white", "bg-maximally-red", "bg-white", "bg-maximally-red"];
          ...
          <section className="py-20 px-4 bg-black">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="minecraft-block bg-maximally-black p-6 md:p-8">
                <div className="space-y-4 text-white font-jetbrains text-base md:text-lg">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="minecraft-block bg-maximally-yellow p-2">
                <div className="minecraft-block bg-maximally-black p-8 md:p-12">
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl text-white mb-8 font-jetbrains italic">
                    "This isn't school. This is the playground."
                  </p>
                  <p className="text-base md:text-lg text-white mb-8 font-jetbrains font-bold">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button 
                      onClick={() => window.open('https://maximally-ai-shipathon.devpost.com/', '_blank')}
                      className="pixel-button bg-white text-black font-press-start py-4 md:py-6 px-6 md:px-10 text-lg md:text-xl hover:scale-110 transition-all duration-300 border-2 border-white"
                    >
                      🚢 REGISTER ON DEVPOST
                    </Button>
                  </div>
