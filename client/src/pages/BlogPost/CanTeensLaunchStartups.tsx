...
const CanTeensLaunchStartups = () => {
  const content = (
    <div className="space-y-6">
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>How to validate ideas</li>
        <li>How to communicate clearly</li>
        <li>How to bounce back from failure</li>
        <li>How to pitch with confidence</li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Building apps that help students manage mental health</li>
        <li>Creating platforms that connect communities</li>
        <li>Developing solutions for environmental challenges</li>
        <li>Designing tools that make education more accessible</li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>Hands-on experience:</strong> Build actual prototypes, not just presentations</li>
        <li><strong>Real mentorship:</strong> Learn from successful entrepreneurs and industry experts</li>
        <li><strong>Market validation:</strong> Test your ideas with real users and get genuine feedback</li>
        <li><strong>Community support:</strong> Connect with like-minded peers who challenge and inspire you</li>
      ...
      <ol className="list-decimal pl-6 space-y-2">
        <li><strong>Identify a problem</strong> you're passionate about solving</li>
        <li><strong>Research and validate</strong> that others share this problem</li>
        <li><strong>Design a solution</strong> that addresses the core issue</li>
        <li><strong>Build a prototype</strong> to test your assumptions</li>
        <li><strong>Get feedback</strong> from real users</li>
        <li><strong>Iterate and improve</strong> based on what you learn</li>
        <li><strong>Scale and impact</strong> more lives</li>
      </ol>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>Leadership:</strong> How to motivate and coordinate teams</li>
        <li><strong>Communication:</strong> How to present ideas clearly and persuasively</li>
        <li><strong>Resilience:</strong> How to bounce back from setbacks and failures</li>
        <li><strong>Critical thinking:</strong> How to analyze problems and evaluate solutions</li>
        <li><strong>Empathy:</strong> How to understand and serve user needs</li>
      </ul>
      ...
      <p>
        The best time to start building is now. The best place to start is with a community that believes in your potential and provides the support you need to succeed.
      </p>
      
      <p className="text-lg font-bold">
        Ready to launch your startup journey? Apply for the next Makeathon at Maximally.
      </p>
      
      <p className="text-sm text-maximally-black/70">
        Because the world needs what you have to offer. And it's time to start building it.
      </p>
    </div>
  );
...
export default CanTeensLaunchStartups;
