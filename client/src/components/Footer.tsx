      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex justify-center space-x-6">
            ...
            <a href="https://discord.gg/WmSXVzDYuq" className="group" target="_blank" rel="noopener noreferrer">
              <div className="pixel-card bg-gradient-to-br from-indigo-500 to-purple-600 hover:scale-110 transition-transform p-3">
                <svg className="h-8 w-8 text-white group-hover:animate-pulse" fill="currentColor" viewBox="0 0 24 24">
